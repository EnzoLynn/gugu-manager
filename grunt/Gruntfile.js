    ...
    grunt.initConfig({
        ...
        concat: {
            ...
            dist: {
                ...
                ,'<%= jsdest %>**/MyPasswordfield.js','<%= jsdest %>**/html5FileUpload.js'
                ,'<%= jsdest %>**/MyStateProvider.js','<%= jsdest %>**/chinamapPath.js'
                ,'<%= jsdest %>**/raphael.js'
                ...
                ,'<%= jsdest %>**/Customer_numberGrid.js','<%= jsdest %>**/Customer_number_allGridAction.js'
                ,'<%= jsdest %>**/Customer_number_allGrid.js' 
                ,'<%= jsdest %>**/CustomerRentGridModel.js'
