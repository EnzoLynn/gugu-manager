Ext.create('Ext.data.Store', {
    model: 'chl.Model.Express_pointGridModel',
    storeId: 'Express_pointGridStoreId',
    ...
    proxy: {
        type: 'ajax',
        api: GlobalConfig.Controllers.Express_pointGrid,
        filterParam: 'filter',
        sortParam: 'sort',
        directionParam: 'dir',
        limitParam: 'limit',
        ...
        extraParams: {
            req: 'data',
            dataname: 'Express_point',             //dataset名称，根据实际情况设置,数据库名
            restype: 'json',
