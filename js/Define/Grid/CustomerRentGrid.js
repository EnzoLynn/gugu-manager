...
ActionManager.editCustomerRule = function(target, record) {
    ...
    WsCall.call(GlobalConfig.Controllers.CustomerGrid.GetCustomerRuleByRentId, 'GetCustomerRuleByRentId', param, function(response, opts) {
        ...
        WindowManager.AddUpdateCustomerRuleWin.show(null, function() {
            ...
            if (Ext.isGecko) {
                WindowManager.AddUpdateCustomerRuleWin.el.unmask();
            }
        ...
        items: [{
            ...
            listeners: {
                boxready: function(com) {
                    ...
                    //                 GlobalFun.CustomerRent_CreateRuleFun(com);
...
GlobalFun.CustomerRent_CreateRuleFun = function(com) {
    var param = {
                ...
                listeners: {
                    ...
                    beforehide: function(com) {
                        ...
                        WsCall.call(GlobalConfig.Controllers.CustomerGrid.GetCustomerRuleByRentId, 'GetCustomerRuleByRentId', param, function(response, opts) {
                            ...
                            //GlobalFun.CreatChinaSvg(WindowManager.AddUpdateCustomerRuleWin.down('fieldset'));
                            GlobalFun.InitChinaSvgDataEvent(data, function(code) {
                                GlobalFun.CustomerRent_CreateRuleFun({
                                    myval: code
                                });
