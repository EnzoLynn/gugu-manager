    ...
    var tmpArr = [{
        ...
        renderer: function(value, metaData, record) {
            if (record.data.import_status == 1) {
                return "<span onclick='GridManager.AttachFileGridSerachfor_file_id(" + value + ")'>" + value + "&nbsp;<img src='/dist/image/toolbar/NewDoc.png' style='margin-bottom: -2px;height:14px;'></span>";
